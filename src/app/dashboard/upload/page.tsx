...
import {
  Code2, FileImage, FileText, Upload, CheckCircle2,
  ExternalLink, Loader2, FileCheck, AlertCircle,
} from "lucide-react";
...
function UploadAssetsPage() {
  ...
  useEffect(() => { if (isSuccess)      toast.success("Archive confirmed on Filecoin Calibration!"); }, [isSuccess]);
  ...
  return (
    ...
    >
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 flex flex-col gap-4">
              ...
              <div
                ...
                style={{
                  border: `1.5px dashed ${
                    dragging ? "#1A92FF" : selectedFile ? "rgba(74,225,131,0.4)" : "rgba(255,255,255,0.1)"
                  }`,
              ...
              >
                ...
                {selectedFile ? (
                  <>
                    ...
                    <p className="text-xs font-medium px-4 text-center truncate max-w-full" style={{ color: "#DFE2F3" }}>
                      {selectedFile.name}
                    </p>
              ...
              <div className="flex items-center gap-2 md:gap-3">
                {FILE_TYPES.map(({ icon: Icon, label }) => (
                  <button
                    ...
                    style={{
                      backgroundColor: activeFileType === label
              ...
              <div className="flex flex-col gap-2">
                {!isConnected ? (
                  <ConnectButton.Custom>
                    {({ openConnectModal }) => (
                      <button
                        ...
                        className="w-full py-3 md:py-2.5 rounded-lg text-xs font-semibold transition-opacity hover:opacity-80"
                  ...
                  <button
                    ...
                    className="w-full py-3 md:py-2.5 rounded-lg text-xs font-semibold transition-opacity hover:opacity-80 flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed"
                    style={{
                      backgroundColor: cidReady ? "rgba(74,225,131,0.12)" : "rgba(26,146,255,0.15)",
              ...
              {/* Mini footer — desktop only */}
              <div
                className="hidden md:block mt-auto pt-4 border-t"
                style={{ borderColor: "rgba(255,255,255,0.06)" }}
              >
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex flex-col gap-1 items-end">
                    {["Documentation", "Smart Contracts", "Privacy", "Nodes"].map((l) => (
                      <a key={l} href="#" className="text-[10px] transition-opacity hover:opacity-70" style={{ color: "#8A919F" }}>
                        {l}
                      </a>
                    ))}
                  </div>
            ...
            <div className="w-full md:w-56 flex-shrink-0 flex flex-col gap-4">
              ...
              <div
                ...
                style={{
                  ...
                  borderColor: isSuccess ? "rgba(74,225,131,0.3)" : "rgba(255,255,255,0.08)",
                }}
              >
                ...
                {!isConnected ? (
                  <ConnectButton.Custom>
                    {({ openConnectModal }) => (
                      <button
                        onClick={openConnectModal}
                        className="w-full py-3 md:py-2 rounded-md text-xs font-semibold transition-opacity hover:opacity-80"
                        style={{ backgroundColor: "#1A92FF", color: "#0A0E1A" }}
                      >
                        Connect Wallet
                      </button>
                  ...
                  <button
                    ...
                    className="w-full py-3 md:py-2 rounded-md text-xs font-semibold transition-opacity hover:opacity-80 flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed"
                    style={{
              ...
              >
                ...
                <p className="text-[10px] mb-3" style={{ color: "#8A919F" }}>
                  © 2024 Sovereign · Technically Secured.
                </p>
      ...
      {/* Mobile bottom nav */}
      <div
        className="fixed bottom-0 left-0 right-0 md:hidden border-t z-50"
        style={{ backgroundColor: "#0A0E1A", borderColor: "rgba(255,255,255,0.07)" }}
      >
        <Aside mobile />
      </div>
    </div>
