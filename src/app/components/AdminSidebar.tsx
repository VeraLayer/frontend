...
const MAIN_NAV = [
  { icon: <LayoutDashboard size={15} />, label: "Dashboard",       href: "/admin" },
  { icon: <BarChart2 size={15} />,       label: "Analytics",       href: "/admin/analytics" },
  { icon: <FileStack size={15} />,       label: "All Submissions",  href: "/admin/submissions" },
  { icon: <Users size={15} />,           label: "Talent",          href: "/admin/talent" },
  { icon: <Landmark size={15} />,        label: "Heritage",        href: "/dashboard/heritage" },
  { icon: <Clock size={15} />,           label: "Pending",         href: "/admin/pending" },
  { icon: <Flag size={15} />,            label: "Flagged",         href: "/admin/flagged" },
];

const SYSTEM_NAV = [
  { icon: <Monitor size={15} />,  label: "Monitor",  href: "/admin/monitor" },
